...
from iotqautils.cb_utils import EntitiesConsults, PayloadUtils, NotifyConditions, ContextElements, AttributesCreation, MetadatasCreation
...
def create_subscription(context):
        ...
        #TestUtils.set_service_and_subservice(context, context.table[0]["service"], context.table[0]["subservice"])
