Feature: Happy path E2E functionality Sync-Async
  ...
  In a Service servicewwk and Subservice thinkinthing
  As a client has SYNC  BlackButtons: SSwwk1011 and SAwwk1022
  As a client has ASYNC BlackButtons: ASwwk1033 and SSwwk1044
  ...
  Scenario Outline: SC_1 Service and BlackButton get provisioned in BB-platform
    ...
    Examples:
      ...
      | servicewwk1 | thinkinthing | admin_bb           | password    | SSwwk1011 | synchronous          | synchronous    | TP/sync/request |
      | servicewwk2 | thinkinthing | admin_bb           | password    | SAwwk1022 | synchronous          | asynchronous   | TP/async/create |
      | servicewwk3 | thinkinthing | admin_bb           | password    | ASwwk1033 | asynchronous         | synchronous    | TP/sync/request |
      | servicewwk4 | thinkinthing | admin_bb           | password    | AAwwk1044 | asynchronous         | asynchronous   | TP/async/create |
      | servicewwk5 | thinkinthing | admin_bb           | password    | SSwwk1055 | synchronous          | synchronous    | TP/sync/request |
  ...
  Scenario Outline: SC_2 User check a BlackButton is registered in BB-platform
    ...
    Examples:
      ...
      | servicewwk1 | thinkinthing | admin_bb           | password    | SSwwk1011 |
      | servicewwk2 | thinkinthing | admin_bb           | password    | SAwwk1022 |
      | servicewwk3 | thinkinthing | admin_bb           | password    | ASwwk1033 |
      | servicewwk4 | thinkinthing | admin_bb           | password    | AAwwk1044 |
  ...
  Scenario Outline: SC_3 Client push the button in the SYNC mode
    ...
    Examples:
      ...
      | servicewwk1 | thinkinthing | SSwwk1011 | synchronous | #3,BT,S,4,5,2000$WakeUp,#0,K1,30$ | TP      | #3,BT,S,1,rt-20;rrgb-00FF00;,0$#0,K1,300$, |
      | servicewwk2 | thinkinthing | SAwwk1022 | synchronous | #1,BT,S,2,1,2000$WakeUp,#0,K1,30$ | TP      | #1,BT,S,1,rt-20;rrgb-00FF00;,0$#0,K1,300$, |
  ...
  Scenario Outline: SC_4 Client push the button in the ASYNC mode
    ...
    Examples:
      ...
      | servicewwk3 | thinkinthing | ASwwk1033 | asynchronous | #1,BT,C,3,2,2000$WakeUp,#0,K1,30$ | C.S    | C.S          |
      | servicewwk4 | thinkinthing | AAwwk1044 | asynchronous | #1,BT,C,1,1,2000$WakeUp,#0,K1,30$ | C.S    | C.S          |
  ...
  Scenario Outline: SC_5 Clean SERVICE data generated in happy path scenarios
    ...
    Examples:
      ...
      | servicewwk1 | thinkinthing | admin_bb           | 4pass1w0rd       | password    |
      | servicewwk2 | thinkinthing | admin_bb           | 4pass1w0rd       | password    |
      | servicewwk3 | thinkinthing | admin_bb           | 4pass1w0rd       | password    |
      | servicewwk4 | thinkinthing | admin_bb           | 4pass1w0rd       | password    |
      | servicewwk5 | thinkinthing | admin_bb           | 4pass1w0rd       | password    |
