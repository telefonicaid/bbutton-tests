Feature: IotAgent for MQTT
  ...
  Scenario Outline: SC_2 Multiple measure received
    ...
    Examples:
      | SERVICE     | SERVICEPATH  | DEVICE_ID | ENT_NAME  | ENT_TYPE  | ATT        | MSG                                                       |
      | gdlservice1 | gdltt1       | multi1    | mqttname1 | mqtttype1 | attributes | {"T": 31.4, "H":200}                                      |
      | gdlservice2 | thinkinthing | multi2    | mqttname3 | 3mqtttype | attributes | {"NORTH": "3.0", "EAST":9.1,"HIGH":9.000001,"Z":9.999999} |
...
#    And a service and subservice are provisioned
    ...
    Then CB should have received the "<EXPECTED>" entity update with multiple values from "<MSG>"
    And service and subservice are deleted with "admin_bb" and "4passw0rd" credentials

    Examples:
      | SERVICE  | SERVICEPATH | DEVICE_ID  | EXPECTED                | MSG                                                                                               | # mcc:mnc:lac:cell-id:dbm
#      | qwer11a2 | char1       | special01a | 00D6:0007:0B00:0D22:None | {"tt":"20160122T121208Z","L":4,"T": 30.2,"H":30,"G":0,"M":3784,"V":"L","C1":"00D600070B000D22"} |
      | qwer11a2 | char2       | special01a | 00D6:0007:0B00:0D22:-64 | {"tt":"20160122T121208Z","L":4,"T": 30.2,"H":30,"G":0,"M":3784,"V":"L","P1":"214,7,d22,b00,-64,"} |
